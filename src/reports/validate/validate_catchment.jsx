...
const [notCompletedEnrollments, setNotCompletedEnrollments] = useState([]);
  ...
  const Events = [{ key: "nearby", name: [15] }];
  const Enrollment = [{ key: "nearby", name: [11] }];
...
console.log(notCompleted)
    ...
    fetchData();
}, [orgUnitId, year, Encode, onStatusChange]);
  ...
  return (
    <div className="container mt-3" style={{ fontFamily: "'Noto Sans Lao', sans-serif" }}>
      <h6 className="mb-3">Program: Facility Mapping D – Catchment Area Accessibility</h6>
      {/* <p>{enrollmentRows}</p> */}
...
export default Valtdate_catchment;
